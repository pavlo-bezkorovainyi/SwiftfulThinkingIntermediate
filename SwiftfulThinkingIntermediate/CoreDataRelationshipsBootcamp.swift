...
//
//  Created by Павел Бескоровайный on 09.08.2023.
//
...
//    request.predicate = filter
  ...
  func updateBusiness() {
    let exisitingBusiness = businesses[2]
    exisitingBusiness.addToDepartments(departments[5])
    save()
  }
  ...
  func addBusiness() {
    ...
    //add departments to the new businesses
    //newBusiness.departments = [departments[1], departments[5] ]
    
    //add existing employees to hte new business
  ...
  func addEmployee() {
    ...
    newEmployee.department = departments[5]
